...
async function getInitialListingData() {
    ...
    return fs
        ...
        .then((newListings) =>
            fs.outputJson(simpleListingPath, _.uniq([...newListings, ...simpleListing]), { spaces: 4 })
        )
        .then(() => simpleListing);
}
...
async function start() {
    ...
    return fs
        ...
        .then((newListings) =>
            fs.outputJson(detailedListingPath, _.uniq([...newListings, ...detailedListing], 'id'), { spaces: 4 })
        )
